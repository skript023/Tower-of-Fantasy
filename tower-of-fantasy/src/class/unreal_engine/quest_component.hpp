...
#pragma pack(push, 1)
	...
	static_assert(sizeof(AcceptedObjectiveProgress) == 0x24);
	...
	static_assert(sizeof(ObjectiveProgress) == 0xB0);
	...
	public:
		...
		TArray<AcceptedObjectiveProgress> m_objective_progress; //0x0010
