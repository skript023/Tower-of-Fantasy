...
#define THREAD_POOL_BEGIN(...) g_thread_pool->push([__VA_ARGS__] { __try
#define THREAD_POOL_END __except (script::script_exception_handler(GetExceptionInformation()), EXCEPTION_EXECUTE_HANDLER) {} });
}
